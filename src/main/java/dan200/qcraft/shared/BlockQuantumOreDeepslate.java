...
public class BlockQuantumOreDeepslate extends Block
{
    private static IIcon t_icon;
    private boolean m_glowing;

    public BlockQuantumOreDeepslate(boolean glowing )
    {
        super( Material.rock );
        setHardness( 5.0f );
        setResistance( 5.0f );
        setBlockName( "qcraft:oreDeepslate" );
    ...
    {
        this.glows( par1World, par2, par3, par4 );
    ...
    {
        if( this == QCraft.Blocks.quantumOreGlowingDeepslate )
        {
            world.setBlock( i, j, k, QCraft.Blocks.quantumOreDeepslate );
        }
    }
    ...
    public void randomDisplayTick( World par1World, int par2, int par3, int par4, Random par5Random )
    {
        if( m_glowing )
        {
            this.sparkles( par1World, par2, par3, par4 );
        }
    }

    private void sparkles(World par1World, int par2, int par3, int par4 )
    {
    ...
    private void glows(World world, int i, int j, int k )
    {
        this.sparkles( world, i, j, k );
        if( this == QCraft.Blocks.quantumOreDeepslate )
        {
            world.setBlock( i, j, k, QCraft.Blocks.quantumOreGlowingDeepslate );
        }
    }
    ...
    {
        return new ItemStack( QCraft.Blocks.quantumOreDeepslate );
    }

    @Override
    public void registerBlockIcons( IIconRegister iconRegister )
    {
        t_icon = iconRegister.registerIcon( "qcraft:oreDeepslate" );
    }
